...
namespace PeLibraryTest
{
    ...
    public:
        TEST_METHOD(parse_command_line_with_command_test)
        {
            ...
            COMMAND_LINE_OPTION actual1_1 = parse_command_line(&input1, false, DEFAULT_MEMORY_ARENA);
            ...
            COMMAND_LINE_OPTION actual1_2 = parse_command_line(&input1, true, DEFAULT_MEMORY_ARENA);
            ...
            TEXT input2 = wrap("");
            COMMAND_LINE_OPTION actual2_1 = parse_command_line(&input2, false, DEFAULT_MEMORY_ARENA);
            Assert::AreEqual((size_t)0, actual2_1.count);
            Assert::IsNull(actual2_1.library.command);
            release_command_line(&actual2_1);

            COMMAND_LINE_OPTION actual2_2 = parse_command_line(&input2, true, DEFAULT_MEMORY_ARENA);
        ...
        TEST_METHOD(parse_command_line_item_value_space_test)
        {
            ...
            TEXT input = wrap("abc --def DEF --ghi GHI");
            COMMAND_LINE_OPTION actual = parse_command_line(&input, true, DEFAULT_MEMORY_ARENA);
            for (size_t i = 0; i < SIZEOF_ARRAY(expecteds); i++) {
                const TEXT* expected_key = &expecteds[i][0];
                const TEXT* expected_value = &expecteds[i][1];
        ...
        TEST_METHOD(parse_command_line_item_switch_width_value_test)
        {
            ...
            TEXT input = wrap("abc --def=DEF --ghi= --jkl \"\" --pqr --stu");
            COMMAND_LINE_OPTION actual = parse_command_line(&input, true, DEFAULT_MEMORY_ARENA);
            ...
            Assert::IsFalse(has_value_command_line_item(item4));
        ...
        TEST_METHOD(is_inputted_command_line_item_test)
        {
            ...
            Assert::IsFalse(is_inputted_command_line_item(item4));
        ...
        TEST_METHOD(to_command_line_argument_test)
        {
            ...
            for (auto test : tests) {
                ...
                TEXT actual = to_command_line_argument(arg1.data(), arg1.size(), DEFAULT_MEMORY_ARENA);
