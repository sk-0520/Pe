...
namespace ContentTypeTextNet.Pe.Main.Models.Plugin.Addon
{
    ...
    public sealed class LauncherItemAddonPersistenceStorage: PluginPersistenceStorageBase, ILauncherItemAddonPersistenceStorage
    {
        ...
        public LauncherItemAddonPersistenceStorage(IPluginIdentifiers pluginIdentifiers, IPluginVersions pluginVersions, IDatabaseContext databaseContext, IDatabaseStatementLoader databaseStatementLoader, bool isReadOnly, ILoggerFactory loggerFactory)
        ...
        {
            return ExistsCore((launcherItemId, key), (p, d) => {
                var daoFactory = new AppDaoFactory(d.DatabaseContext, d.DatabaseStatementLoader, d.LoggerFactory);
                var pluginLauncherItemSettingsEntityDao = daoFactory.Create<PluginLauncherItemSettingsEntityDao>();
        ...
        {
            return TryGetCore((launcherItemId, key), (p, d) => {
                var daoFactory = new AppDaoFactory(d.DatabaseContext, d.DatabaseStatementLoader, d.LoggerFactory);
                var pluginLauncherItemSettingsEntityDao = daoFactory.Create<PluginLauncherItemSettingsEntityDao>();
        ...
        {
            return SetCore(value, format, (launcherItemId, key), (p, d, v) => {
                var daoFactory = new AppDaoFactory(d.DatabaseContext, d.DatabaseStatementLoader, d.LoggerFactory);
                var pluginLauncherItemSettingsEntityDao = daoFactory.Create<PluginLauncherItemSettingsEntityDao>();
        ...
        {
            return DeleteCore((launcherItemId, key), (p, d) => {
                var daoFactory = new AppDaoFactory(d.DatabaseContext, d.DatabaseStatementLoader, d.LoggerFactory);
                var pluginLauncherItemSettingsEntityDao = daoFactory.Create<PluginLauncherItemSettingsEntityDao>();
