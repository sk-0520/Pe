...
namespace ContentTypeTextNet.Pe.Main.Models.Database.Dao.Entity
{
    public class NoteViewOffsetsEntityDao: EntityDaoBase
    {
        ...
        public NoteViewOffsetsEntityDao(IDatabaseContext context, IDatabaseStatementLoader statementLoader, IDatabaseImplementation implementation, ILoggerFactory loggerFactory)
