...
namespace ContentTypeTextNet.Pe.Library.Common.Test.Throw
{
    ...
    public class ArgumentComplexExceptionTest
    {
        ...
        {
            var ex = new ArgumentComplexException("message", "param1", "param2", "param3", "param4", "param5");
            Assert.Equal("message (Parameter 'param1, param2, param3, param4, param5')", ex.Message);
            Assert.Equal("param1, param2, param3, param4, param5", ex.ParamName);
            Assert.Equal("param1", ex.ParamNames[0]);
            Assert.Equal("param2", ex.ParamNames[1]);
            Assert.Equal("param3", ex.ParamNames[2]);
            Assert.Equal("param4", ex.ParamNames[3]);
        ...
        [Fact]
        public void Constructor_6_Test()
        {
        ...
        [Fact]
        public void Constructor_7_Test()
        {
            var ex = new ArgumentComplexException("message", "param1", "param2", "param3", "param4", "param5", "param6", "param7");
            Assert.Equal("message (Parameter 'param1, param2, param3, param4, param5, param6, param7')", ex.Message);
            Assert.Equal("param1, param2, param3, param4, param5, param6, param7", ex.ParamName);
            Assert.Equal("param1", ex.ParamNames[0]);
            Assert.Equal("param2", ex.ParamNames[1]);
            Assert.Equal("param3", ex.ParamNames[2]);
            Assert.Equal("param4", ex.ParamNames[3]);
            Assert.Equal("param5", ex.ParamNames[4]);
            Assert.Equal("param6", ex.ParamNames[5]);
            Assert.Equal("param7", ex.ParamNames[6]);
        }
        ...
        [Theory]
        [InlineData(0, null!, "param2", "param3", "param4", "param5", "param6", "param7")]
        [InlineData(1, "param1", null!, "param3", "param4", "param5", "param6", "param7")]
        [InlineData(2, "param1", "param2", null!, "param4", "param5", "param6", "param7")]
        [InlineData(3, "param1", "param2", "param3", null!, "param5", "param6", "param7")]
        [InlineData(4, "param1", "param2", "param3", "param4", null!, "param6", "param7")]
        [InlineData(5, "param1", "param2", "param3", "param4", "param5", null!, "param7")]
        [InlineData(6, "param1", "param2", "param3", "param4", "param5", "param6", null!)]
        [InlineData(6, "param1", "param2", "param3", "param4", "param5", "param6", "")]
        [InlineData(6, "param1", "param2", "param3", "param4", "param5", "param6", " ")]
        public void Constructor_7_throw_Test(int expected, string? paramName1, string? paramName2, string? paramName3, string? paramName4, string? paramName5, string? paramName6, string? paramName7)
        {
            var exception = Assert.Throws<ArgumentComplexParameterNameException>(()
                => new ArgumentComplexException("message", paramName1!, paramName2!, paramName3!, paramName4!, paramName5!, paramName6!, paramName7!)
            );
            Assert.Equal(expected, exception.Index);
            Assert.Equal($"Parameter name[{expected}] is null or empty.", exception.Message);
        }
