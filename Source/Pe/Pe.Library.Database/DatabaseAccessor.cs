...
namespace ContentTypeTextNet.Pe.Library.Database
{
    ...
    public class DatabaseAccessor: DatabaseContextBase, IDatabaseAccessor
    {
        ...
        private DbConnectionWrapper OpenConnection()
        {
            ...
            connection.Open();
            IsOpened = true;
            return CreateDbConnectionWrapper(connection);
        }
        ...
        protected override DbConnectionWrapper DbConnection
        {
            get
            {
                ThrowIfDisposed();
        ...
        where TDbConnection : IDbConnection
    {
        ...
        /// 接続元。
        /// </summary>
        public new TDbConnection DbConnection => (TDbConnection)BaseDbConnection.Connection;
