...
#pragma warning disable CS8610 // パラメーターの型における参照型の Null 許容性が、オーバーライドされるメンバーと一致しません。
#pragma warning disable CS8614 // パラメーターの型における参照型の Null 許容性が、暗黙的に実装されるメンバーと一致しません。
#pragma warning disable CS8602 // null 参照の可能性があるものの逆参照です。
...
#endif
    {
        ...
        ///</summary>
        [Description("The signature of the certificate can not be verified.")]
        ...
        ///</summary>
        [Description("Reading / writing Extensions where Attributes are appropriate, and visa versa.")]
        ...
        ///</summary>
        [Description("A certificate that can only be used as an end-entity is being used as a CA or visa versa.")]
        ...
        ///</summary>
        [Description("This operation can not be performed on the system application")]
...
#pragma warning restore IDE0009 // メンバー アクセスを修飾する必要があります。
#pragma warning restore CS8610 // パラメーターの型における参照型の Null 許容性が、オーバーライドされるメンバーと一致しません。
#pragma warning restore CS8614 // パラメーターの型における参照型の Null 許容性が、暗黙的に実装されるメンバーと一致しません。
